...
v0.5-qemu-img-adapter: 加 qemu_img (info 探测) + qemu_img_extract (convert 写盘)
...
from automisc.tools.misc.archive import qemu_img  # noqa: F401  # v0.5-qemu-img-adapter
from automisc.tools.misc.archive import qemu_img_extract  # noqa: F401  # v0.5-qemu-img-adapter
