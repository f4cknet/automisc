...
TOOL_CATEGORIES: dict[str, list[str]] = {
    ...
    "快捷工具 (v0.5 Actions)": [
        ...
        "lsb_extract",  # PNG LSB 抽出 (LSBExtractAction, zsteg subprocess, Win 不可用, v0.5-lsb-tool-unify Phase 6 DEPRECATED → lsb_tool)
...
ACTION_DISPLAY_NAMES: dict[str, str] = {
    ...
    # v0.5-trid-toolbar (per Owner 2026-07-01 22:00 拍板): GUI 显示名"文件类型识别"
...
ADAPTER_TOOLS: set[str] = {
    "file", "strings", "binwalk", "foremost", "exiftool", "xxd", "trid",  # v0.5-trid-toolbar 加 trid
