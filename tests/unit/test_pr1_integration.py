...
EXPECTED_TOOLS = {
    ...
    # PR2: Stego/Image
    "zsteg", "steghide",  # v0.5-stegseek-remove: stegseek 删, 改 steghide
}
...
def test_pr2_adapters_have_steganography_image_category():
    """PR2 2 个 adapter 的 category 是 'steganography_image' (v0.5-stegseek-remove: stegseek -> steghide)."""
...
def test_orchestrator_can_run_pr2_on_png(tmp_png_file):
    ...
    for name in ("zsteg", "steghide"):  # v0.5-stegseek-remove: stegseek 删, 改 steghide
        result = core.run_tool(name, file_path)
