...
| P7 | `v0.1.0b-PR7-envfix` | **前置环境修复（解决 vol.py blocker）**：vol2 留 v0.5+ docker；v0.1 adapter 默认走 vol3（`pip install volatility3`）。决策记录在 `docs/decisions/v0.1.0b-PR7-vol-environment.md` | ✅ | 1h | **已完成**（commit `待定`，2026-06-13 17:55）；**依赖**：PR9；**不写 adapter**，只解决"装得上" |
